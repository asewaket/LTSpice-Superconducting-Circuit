# MoTe2 superconducting network MATLAB scaffold, v5.5

This folder is the v5.5 iteration of the MATLAB project built from
`Res_Array_1.m`.
...
`abs_shift_proxy`. This map is a spatial-response constraint, not a calibrated
strain map and not yet a direct replacement for `eta` in the transport solver.
