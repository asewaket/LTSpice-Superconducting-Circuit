function projectDir = add_v745_paths()
%ADD_V745_PATHS Add v7.4.5 project and bundled helper paths.
%
...
% v7.4.5 copies. Put v7.4.5 first and remove older v7 model paths so the
...
% Clear only common v7.4.5 entry points/helpers so edited files are picked up
% without requiring a full MATLAB restart.
clear apply_light_figure_style
clear build_v745_bottleneck_case
clear link_resistance_TI_v741
clear plot_v745_bottleneck_summary
clear run_v745_as006_physical_bottleneck_sweep
clear run_v745_as006_best_maps_only
