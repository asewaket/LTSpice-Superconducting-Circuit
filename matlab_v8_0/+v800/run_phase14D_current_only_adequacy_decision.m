...
activeRows = ~ismember(lower(string(inputs.b5SharedParameterLedger.role)), ...
    ["blocked"; "conditional_future_ablation_only"]);
sharedOnly = ~any(inputs.b5SharedParameterLedger.device_specific == 1 & ...
    activeRows);
