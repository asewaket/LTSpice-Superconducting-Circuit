function opts = make_v744_bottleneck_options()
%MAKE_V744_BOTTLENECK_OPTIONS Physically constrained bottleneck sweep.
%
% v7.4.4 keeps the v7.4.3 discipline of varying only W_ij, interpreted as
...
opts.gammaW_values = [0.001, 0.003, 0.010, 0.030];
opts.pW_values = [0.03, 0.06, 0.10];
