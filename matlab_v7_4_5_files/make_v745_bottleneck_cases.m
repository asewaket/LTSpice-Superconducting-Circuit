function cases = make_v745_bottleneck_cases(opts)
%MAKE_V745_BOTTLENECK_CASES Build physical bottleneck W_ij topology cases.
%
% For each gammaW/pW pair, v7.4.5 tests named bottleneck mechanisms:
