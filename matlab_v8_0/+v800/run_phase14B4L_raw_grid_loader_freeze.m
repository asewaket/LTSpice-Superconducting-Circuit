...
row = struct( ...
    ...
    'current_points', NaN, 'temperature_points', NaN, ...
    'dVdI_size', "", 'field_T', NaN, 'grid_lock_status', "");
end
...
meta = struct( ...
    ...
    'positive_negative_current_present', false, ...
    'missing_value_count', NaN, 'duplicate_pair_count', NaN, ...
    'matrix_columns', "", 'dVdI_rows', NaN, 'dVdI_cols', NaN, ...
...
gate = [
    ...
    "Probe and field conditions explicit"
...
note = [
    ...
    "Probe pair and fixed-field context are explicit."
