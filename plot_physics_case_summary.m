...
%PLOT_PHYSICS_CASE_SUMMARY Thesis-facing v6.5 case comparison.
...
h = figure('Name', 'v6.5 physics-informed case summary', 'Color', 'w', ...
...
sgtitle('v6.5 literature-informed superconducting-network cases A--E');
