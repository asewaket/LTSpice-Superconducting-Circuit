function [netCase, paramsCase, weak] = build_v744_bottleneck_case(netBase, spec, ...
    paramsBase, caseInfo, opts, calibrationMode, fullNormalScale)
%BUILD_V744_BOTTLENECK_CASE Apply one physical bottleneck W_ij case.
%
% calibrationMode:
...
[WX, WY, weak] = make_v744_bottleneck_field(netBase, spec, caseInfo, opts);
...
function [WX, WY, weak] = make_v744_bottleneck_field(net, spec, caseInfo, opts)
...
weak.pW = caseInfo.pW;
weak.definition = ['v7.4.4 physical bottleneck W_ij ablation: weak-link ', ...
...
scores = v744_physical_bottleneck_scores(net, spec, opts);
...
[maskX, maskY] = select_v744_mask(scoreX, scoreY, net, caseInfo.pW);
...
function scores = v744_physical_bottleneck_scores(net, spec, opts)
...
function [maskX, maskY] = select_v744_mask(scoreX, scoreY, net, frac)
