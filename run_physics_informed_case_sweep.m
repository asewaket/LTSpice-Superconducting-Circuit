%RUN_PHYSICS_INFORMED_CASE_SWEEP v6.5 literature-informed cases A--E.
%
% The cases are:
...
for d = 1:numel(opts.devices)
    ...
    fprintf('  best v6.5 physics-informed score = %.4g\n', bestCombined);
end
...
fprintf('\nFinished v6.5 physics-informed case sweep.\n');
