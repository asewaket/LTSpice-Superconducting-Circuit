# MoTe2 superconducting network MATLAB scaffold, v3

This folder is the third iteration of the MATLAB project built from
`Res_Array_1.m`.
...
v3 keeps the v2 network/proxy/ensemble structure and adds an experimental-data
comparison layer:
