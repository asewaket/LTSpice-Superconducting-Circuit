...
%GET_PHYSICS_CASE_DEFINITION Literature-motivated v6.5 case definitions.
...
switch caseID
    ...
    otherwise
        error('Unknown v6.5 physics case "%s".', caseID);
end
...
if strcmp(deviceName, 'AS002') && ismember(caseID, {'case_C_crack_edge_domains','case_D_boundary_lane'})
