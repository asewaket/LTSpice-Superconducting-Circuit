...
rows = [
    ...
    scenario_row("coarse_mesh", "mesh_resolution", 0, ...
    cfg.phase7.meshScaleFactors(end), 1.0, ...
    "Coarser mesh/support-mask test.")
    scenario_row("fine_mesh", "mesh_resolution", 0, ...
    cfg.phase7.meshScaleFactors(1), 1.0, ...
    "Finer mesh/support-mask test.")
...
rows = [
    ...
    status_row("next_phase7_step", "phase7B_registered_prior_stress_test", ...
    "Run only if quantitative Raman/mechanical maps and registration transforms are available.")
    ];
